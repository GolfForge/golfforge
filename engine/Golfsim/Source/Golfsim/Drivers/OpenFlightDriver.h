...
//
// ⚠️ LICENSE BOUNDARY: OpenFlight is AGPL-3.0; this project is MIT. We talk to it ONLY as a network
// service over its socket -- we never vendor, copy, or link its source. See Drivers/README.md.
//
